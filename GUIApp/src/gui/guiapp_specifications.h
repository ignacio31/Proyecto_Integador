...
typedef struct WINDOW1_CONTROL_BLOCK_STRUCT
{
    ...
    GX_PROMPT window1_txtNombre;
    GX_PROMPT window1_lblSpeed;
    GX_PROMPT window1_lblSwVersion;
    GX_PROMPT window1_lblHwVersion;
    GX_PROMPT window1_lblProgramadores;
    GX_PROMPT window1_txt_Programador1;
    GX_PROMPT window1_txt_Programador2;
    GX_PROMPT window1_txt_speed;
    GX_PROMPT window1_txtNombre_2;
    GX_PROMPT window1_lblDutyCicle;
    GX_PROMPT window1_txt_duty_cicle;
    GX_PROMPT window1_txtNombre_1;
