...
#define SSP_VERSION_PATCH                   (3U)

/** SSP pack version build number (currently unused). */
#define SSP_VERSION_BUILD                   (0U)

/** Public SSP version name. */
#define SSP_VERSION_STRING                  ("1.5.3")

/** Unique SSP version ID. */
#define SSP_VERSION_BUILD_STRING            ("Built with Renesas Synergy (TM) Software Package version 1.5.3+build.dc348d2a2236")
